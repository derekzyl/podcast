                    ...
                    <Card className={classes.card}>
                        <CardActionArea>
                            ...
                            <CardContent>
                                ...
                                <Typography variant="body2" color="textSecondary" component="p">
                                    It's a well known fact that technology is the trademark of the 21st Century.
                                    However, the effect of technology has affected the way we conduct business
                  </Typography>
                            </CardContent>
                        </CardActionArea>
                        <CardActions className={classes.cardActions}>
                    ...
                    <Card className={classes.card}>
                        <CardActionArea>
                            ...
                            <CardContent>
                                ...
                                <Typography variant="body2" color="textSecondary" component="p">
                                    Technology is an ever evolving field. Software development is considered
                                    the fastest growing occupation in the according to Business Insider
                  </Typography>
                            </CardContent>
                        </CardActionArea>
                        <CardActions className={classes.cardActions}>
